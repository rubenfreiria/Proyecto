...
/* Insert tabla relacion_usuario_animal */
INSERT INTO relacion_usuario_animal (id_usuario, id_animal, fecha, tratamiento)
VALUES (3, 1, '2023-04-30', 'Vacuna anual'),
       (3, 1, '2022-04-25', 'Desparasitación'),
       (3, 1, '2021-08-14', 'Tratamiento para la piel'),
       (3, 2, '2023-05-02', 'Corte de uñas'),
       (3, 2, '2022-11-22', 'Vacuna antirrábica'),
       (3, 2, '2022-05-14', 'Desparasitación'),
       (3, 3, '2023-02-10', 'Tratamiento contra pulgas y garrapatas'),
       (3, 3, '2022-10-18', 'Revisión general'),
       (3, 3, '2022-03-09', 'Desparasitación'),
       (3, 4, '2023-03-25', 'Vacuna antirrábica'),
       (3, 4, '2022-12-05', 'Tratamiento para la piel'),
       (3, 4, '2022-04-15', 'Desparasitación'),
       (3, 5, '2023-01-19', 'Revisión general'),
       (3, 5, '2022-09-06', 'Tratamiento para la tos'),
       (3, 5, '2022-02-28', 'Desparasitación'),
       (3, 6, '2023-04-30', 'Revisión general'),
       (3, 6, '2022-10-25', 'Desparasitación'),
       (3, 6, '2022-03-14', 'Tratamiento dental'),
       (3, 7, '2023-05-02', 'Corte de pelo'),
       (3, 7, '2022-11-22', 'Vacuna antirrábica'),
       (3, 7, '2022-05-14', 'Desparasitación'),
       (3, 8, '2023-02-10', 'Tratamiento contra pulgas y garrapatas'),
       (3, 8, '2022-10-18', 'Revisión general'),
       (3, 8, '2022-03-09', 'Desparasitación'),
       (3, 9, '2023-03-25', 'Vacuna antirrábica'),
       (3, 9, '2022-12-05', 'Tratamiento para la piel'),
       (3, 9, '2022-04-15', 'Desparasitación'),
       (3, 10, '2023-01-19', 'Revisión general'),
       (3, 10, '2022-09-06', 'Tratamiento para la tos'),
       (3, 10, '2022-02-28', 'Desparasitación'),
       (3, 11, '2023-04-30', 'Vacuna anual'),
       (3, 11, '2022-04-25', 'Desparasitación'),
       (3, 11, '2021-08-14', 'Tratamiento para la piel'),
       (3, 12, '2023-05-02', 'Corte de uñas'),
       (3, 12, '2022-11-22', 'Vacuna antirrábica'),
       (3, 12, '2022-05-14', 'Desparasitación'),
       (3, 13, '2023-02-10', 'Tratamiento contra pulgas y garrapatas'),
       (3, 13, '2022-10-18', 'Revisión general'),
       (3, 13, '2022-03-09', 'Desparasitación'),
       (3, 14, '2023-03-25', 'Vacuna antirrábica'),
       (3, 14, '2022-12-05', 'Tratamiento para la piel'),
       (3, 14, '2022-04-15', 'Desparasitación'),
       (3, 15, '2023-01-19', 'Revisión general'),
       (3, 15, '2022-09-06', 'Tratamiento para la tos'),
       (3, 15, '2022-02-28', 'Desparasitación'),
       (3, 16, '2023-04-02', 'Vacuna anual'),
       (3, 16, '2022-03-11', 'Desparasitación'),
       (3, 16, '2021-09-26', 'Tratamiento para la piel');
