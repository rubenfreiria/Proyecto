...
VALUES (2, 1, '2023-04-30', 'Vacuna anual'),
       (2, 1, '2022-04-25', 'Desparasitación'),
       (2, 1, '2021-08-14', 'Tratamiento para la piel'),
       (2, 2, '2023-05-02', 'Corte de uñas'),
       (2, 2, '2022-11-22', 'Vacuna antirrábica'),
       (2, 2, '2022-05-14', 'Desparasitación'),
       (2, 3, '2023-02-10', 'Tratamiento contra pulgas y garrapatas'),
       (2, 3, '2022-10-18', 'Revisión general'),
       (2, 3, '2022-03-09', 'Desparasitación'),
       (2, 4, '2023-03-25', 'Vacuna antirrábica'),
       (2, 4, '2022-12-05', 'Tratamiento para la piel'),
       (2, 4, '2022-04-15', 'Desparasitación'),
       (2, 5, '2023-01-19', 'Revisión general'),
       (2, 5, '2022-09-06', 'Tratamiento para la tos'),
       (2, 5, '2022-02-28', 'Desparasitación'),
       (2, 6, '2023-04-30', 'Revisión general'),
       (2, 6, '2022-10-25', 'Desparasitación'),
       (2, 6, '2022-03-14', 'Tratamiento dental'),
       (2, 7, '2023-05-02', 'Corte de pelo'),
       (2, 7, '2022-11-22', 'Vacuna antirrábica'),
       (2, 7, '2022-05-14', 'Desparasitación'),
       (2, 8, '2023-02-10', 'Tratamiento contra pulgas y garrapatas'),
       (2, 8, '2022-10-18', 'Revisión general'),
       (2, 8, '2022-03-09', 'Desparasitación'),
       (2, 9, '2023-03-25', 'Vacuna antirrábica'),
       (2, 9, '2022-12-05', 'Tratamiento para la piel'),
       (2, 9, '2022-04-15', 'Desparasitación'),
       (2, 10, '2023-01-19', 'Revisión general'),
       (2, 10, '2022-09-06', 'Tratamiento para la tos'),
       (2, 10, '2022-02-28', 'Desparasitación'),
       (2, 11, '2023-04-30', 'Vacuna anual'),
       (2, 11, '2022-04-25', 'Desparasitación'),
       (2, 11, '2021-08-14', 'Tratamiento para la piel'),
       (2, 12, '2023-05-02', 'Corte de uñas'),
       (2, 12, '2022-11-22', 'Vacuna antirrábica'),
       (2, 12, '2022-05-14', 'Desparasitación'),
       (2, 13, '2023-02-10', 'Tratamiento contra pulgas y garrapatas'),
       (2, 13, '2022-10-18', 'Revisión general'),
       (2, 13, '2022-03-09', 'Desparasitación'),
       (2, 14, '2023-03-25', 'Vacuna antirrábica'),
       (2, 14, '2022-12-05', 'Tratamiento para la piel'),
       (2, 14, '2022-04-15', 'Desparasitación'),
       (2, 15, '2023-01-19', 'Revisión general'),
       (2, 15, '2022-09-06', 'Tratamiento para la tos'),
       (2, 15, '2022-02-28', 'Desparasitación'),
       (2, 16, '2023-04-02', 'Vacuna anual'),
       (2, 16, '2022-03-11', 'Desparasitación'),
       (2, 16, '2021-09-26', 'Tratamiento para la piel');
